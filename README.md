...
- **Time controls:** the running timer shows its start and end time. Click ± to add/remove five minutes from this interval only; right-click for 5-, 10-, and 15-minute choices. Remaining time is limited to one minute–three hours.
